...
insert into usr 
(username, passwrd, first_name, last_name, email, birthdate, user_role) 
values 
('kstraneo0', 'pass', 'Kalila', 'Straneo', 'kstraneo0@washington.edu', '12/26/1967', 'admin'),			--1
...
('walvaradof', 'pass', 'Wilie', 'Alvarado', 'walvaradof@upenn.edu', '6/15/1993', 'customer'),			--16
...
​
insert into transction_keeper 
(order_number, total_price, previous_order, transaction_date, tracking_number) 
values 
( , '$22.47',  , '5/13/2021', '#4ECD58'),			--1
( , '$22.82',  , '9/23/2021', '#E03B80'),			--2
( , '$37.55',  , '11/19/2021', '#0EA8E4'),			--3
( , '$33.46',  , '1/27/2022', '#DD72FF'),			--4
( , '$31.76',  , '10/13/2021', '#985659'),			--5
( , '$19.07',  , '8/27/2021', '#896480'),			--6
( , '$32.55',  , '3/2/2021', '#743A36'),			--7
( , '$16.92',  , '4/19/2021', '#BB0FDB'),			--8
( , '$32.68',  , '9/7/2021', '#54CB27'),			--9
( , '$13.33',  , '8/25/2021', '#D9ED1D'),			--10
( , '$21.74',  , '11/30/2021', '#8E6F65'),			--11
( , '$18.26',  , '10/18/2021', '#4BD5D7'),			--12
( , '$12.41',  , '11/30/2021', '#65E80C'),			--13
( , '$16.77',  , '10/29/2021', '#4F59BF'),			--14
( , '$16.18',  , '6/30/2021', '#7F48D8'),			--15
( , '$14.99',  , '6/7/2021', '#EE30BC'),			--16
( , '$31.50',  , '10/30/2021', '#AF7C9D'),			--17
( , '$19.32',  , '5/12/2021', '#8714A1'),			--18
( , '$36.94',  , '10/30/2021', '#5B2DE9'),			--19
( , '$36.51',  , '11/12/2021', '#8CDB14');			--20
...
(first_name, last_name, address1, address2, city, state, zip, ship_speed) 
values 
('Giulietta', 'Leaves', '6 Fulton Place', null, 'Pasadena', 'California', '91186', 'express'), 				--1
('Sammy', 'Dorie', '7 Scott Parkway', null, 'Los Angeles', 'California', '90015', 'express'), 				--2
('Gerome', 'Pavlenko', '103 Garrison Street', null, 'Troy', 'Michigan', '48098', 'express'), 				--3
('Hyacinthie', 'Orteaux', '168 New Castle Parkway', null, 'Orange', 'California', '92867', 'priority'), 	--4
('Jareb', 'Greenhaugh', '7249 Spenser Alley', null, 'Van Nuys', 'California', '91411', 'express'); 			--5
​
​
​
insert into credit_card_info 
(name_on_card, card_number, cvv, expiration_month, expiration_year, billing_zip, credit_card_type, ship_add_id) 
values 
